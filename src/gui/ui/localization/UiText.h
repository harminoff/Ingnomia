...
private:
	...
	{
		return {
			{"hud.build.unavailable","Unavailable: missing materials"},{"ui.error.build_materials_unavailable","Cannot place: required materials are unavailable"},
			{"common.close","Close"},{"common.locate","Locate"},{"common.refresh","Refresh"},{"common.cancel","Cancel"},
			...
			{"status.updating","Updating authoritative game state…"},{"status.refreshing","Refreshing authoritative data…"},{"error.missing_key","Missing text: {key}"},
			...
			{"management.stockpile_summary","{items} / {capacity} items | {reserved} reserved | priority {priority} / {maximum}"},{"management.agriculture_summary","Priority {priority} / {maximum} | plots {plots} | planted {planted} | ready {ready}"},
