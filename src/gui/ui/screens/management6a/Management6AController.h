...
public:
	...
	void setStockpileFilterCategory( CatalogId );
	void setStockpileContentSearch( std::string );
	void setStockpileColumnFilter( bool allowList, std::size_t column, std::string );
	void toggleStockpileColumnSelection( bool allowList, std::size_t column, std::string );
	void setStockpileContentSort( StockpileSortKey );
	void setStockpileAllowSort( StockpileSortKey );
	void toggleSort();
	...
	void toggleStockpileContentExpansion( StockpileContentRowId );
	...
	void setWorkshopPane( WorkshopPane );
	void setWorkshopOrderMaterial( std::size_t, CatalogId );
 ...
 void setWorkshopBasics( std::string, std::int32_t, bool, bool, bool, std::optional<bool> linkStockpile = std::nullopt );
	...
	void useFarmDefaultForSelectedPlots();
	void queueSelectedFarmPlotCrop( std::uint32_t count, bool repeat );
	void cancelFarmPlotOrder( WorldPosition, std::uint32_t );
	void moveFarmPlotOrder( WorldPosition, std::uint32_t, MoveDirection );
